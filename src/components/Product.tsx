  ...
  return (
    <div className="py-10">
      <motion.div
        ...
        className="relative"
      >
        <div className="absolute w-[2rem] h-[2rem] flex justify-center items-center text-2xl cursor-pointer -left-20 -top-16  "><Link href={"/"}><PiArrowCircleLeftFill className="text-2xl" /></Link> </div>
        <Image
          src={activeImage}
          alt="thumbnail"
          height="1000"
